...
# 🌟 자일렌 (Xylene) 이성질체 그룹
    ...
    "95-47-6":   {"WE": "O", "SH": "O", "threshold": 1.0}, # o-자일렌
    "108-38-3":  {"WE": "O", "SH": "O", "threshold": 1.0}, # m-자일렌
    "106-42-3":  {"WE": "O", "SH": "O", "threshold": 1.0}, # p-자일렌

    # 🌟 크레졸 (Cresol) 이성질체 그룹
    "1319-77-3": {"WE": "O", "SH": "O", "threshold": 1.0}, # 크레졸 (혼합물)
    "95-48-7":   {"WE": "O", "SH": "O", "threshold": 1.0}, # o-크레졸
    "108-39-4":  {"WE": "O", "SH": "O", "threshold": 1.0}, # m-크레졸
    "106-44-5":  {"WE": "O", "SH": "O", "threshold": 1.0} # p-크레졸
